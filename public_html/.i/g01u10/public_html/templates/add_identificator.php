...
if($_POST){
    ...
    if(empty($errors)){
        ...
        generateForm($errors, $show_select);
    }
}
else{
    generateForm(null, $show_select);
}

function generateForm($errors = null, $show_select = true){
    echo '
...
function generateSelect($show_select){
    if($show_select){
